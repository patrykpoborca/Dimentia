...
function SetUpRotation (centerPos : Vector3, headPos : Vector3)
{
	...
	var yRotation = Quaternion.LookRotation(Vector3(offsetToCenter.x, offsetToCenter.y, offsetToCenter.z));

	var relativeOffset = Vector3.forward * distance + Vector3.down * height;
	//cameraTransform.rotation.x = yRotation.x * Quaternion.LookRotation(relativeOffset).x;
//cameraTransform.rotation.z = yRotation.z * Quaternion.LookRotation(relativeOffset).z;
